...
const WithHead: React.FC<IProps> = ({
  title,
  description = `모두CBT는 국가고시 실기시험 준비를 도와주는 서비스 입니다.\n 산업안전기사 실기,산업안전산업기사 실,건설안전기사 실기, 정보처리기사 실기, 전기기사 실기, 모두시비티,모두씨비티,나눔시비티,씨비티,나눔cbt`,
  image = '/png/logo01.png',
  keywords = '산업안전기사,산업안전기사실기,건설안전기사,건선안전기사실기,모두씨비티,나눔시비티,나눔씨비티,나눔,나눔cbt,comcbt,엔지니오,모두시비티,산업안전기사필답형,건설안전기사필답형,산업안전기사실기CBT,전기기사,전기기사실기,전기기사실기CBT,전기기사실기단답형,전자문제집,모두CBT,정보처리기사,정보처리기사실기,정보처리기사실기CBT',
  pageHeadingTitle,
}) => {
