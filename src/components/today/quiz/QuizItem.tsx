...
const QuizItem: React.FC<QuizItemProps> = ({ number, quiz }) => {
  ...
  const onClickAnswerSubmitButton = (id: number) => {
    ...
    Modal.confirm({
      title: isEditMode ? '수정하시겠습니까?' : '제출하시겠습니까?',
      okText: '확인',
      cancelText: '취소',
      onOk: async () => {
          ...
          {isAnswerSubmitted && (
            <div className="quiz-item-solution-container">
              <div>
                ...
                <div className="quiz-item-solution-label">{'내 답안'}</div>
              ...
              <div>
                <div className="quiz-item-solution-label">{'정답'}</div>
                <pre className="quiz-item-solution">
                  {parse(quiz.question.solution)}
                </pre>
                {quiz.question.solution_img &&
              ...
              <div>
                <div className="quiz-item-solution-label">
                  {'제출된 답안 리스트'}
                </div>
                <QuizComment comments={quiz.comment} />
              </div>
            </div>
          )}
        </QuizItemBlock>
