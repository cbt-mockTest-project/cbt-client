...
export type ReadMyQuestionCardCategoriesQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadMyQuestionCardCategoriesQuery = {
  __typename?: 'Query';
...
export type CreateQuestionCardCategoryMutation = {
  __typename?: 'Mutation';
...
export type UpdateQuestionCardCategoryMutation = {
  __typename?: 'Mutation';
...
export type DeleteQuestionCardCategoryMutation = {
  __typename?: 'Mutation';
...
export type ReadMyQuestionCardsQuery = {
  __typename?: 'Query';
  readMyQuestionCards: {
...
export type CreateQuestionCardMutation = {
  __typename?: 'Mutation';
  createQuestionCard: {
...
export type UpdateQuestionCardMutation = {
  __typename?: 'Mutation';
  updateQuestionCard: {
...
export type DeleteQuestionCardsMutation = {
  __typename?: 'Mutation';
  deleteQuestionCards: {
...
export function useReadMyQuestionCardCategoriesQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadMyQuestionCardCategoriesQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: ReadMyQuestionCardCategoriesDocument, ...options });
}
...
export function useCreateQuestionCardCategoryMutation() {
  ...
  >(CreateQuestionCardCategoryDocument);
}
...
export function useUpdateQuestionCardCategoryMutation() {
  ...
  >(UpdateQuestionCardCategoryDocument);
}
...
export function useDeleteQuestionCardCategoryMutation() {
  ...
  >(DeleteQuestionCardCategoryDocument);
}
...
export function useReadMyQuestionCardsQuery(
  options: Omit<Urql.UseQueryArgs<ReadMyQuestionCardsQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    ReadMyQuestionCardsQuery,
    ReadMyQuestionCardsQueryVariables
  >({ query: ReadMyQuestionCardsDocument, ...options });
}
