...
export type CreateSettlementRequestMutation = {
  __typename?: 'Mutation';
...
export type GetSettlementRequestsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;
...
export type GetSettlementRequestsQuery = {
  ...
  getSettlementRequests: {
    ...
    settlementRequests?: Array<{
      ...
      created_at: any;
      id: number;
      status: Types.SettlementRequestStatus;
      updated_at: any;
      user: {
        __typename?: 'User';
        email: string;
...
export type GetMySettlementRequestQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetMySettlementRequestQuery = {
  __typename?: 'Query';
...
export type GetMySettlementRequestsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetMySettlementRequestsQuery = {
  __typename?: 'Query';
...
export type UpdateSettlementRequestMutation = {
  __typename?: 'Mutation';
...
export function useCreateSettlementRequestMutation() {
  ...
  >(CreateSettlementRequestDocument);
}
...
export function useGetSettlementRequestsQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetSettlementRequestsQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: GetSettlementRequestsDocument, ...options });
}
...
export function useGetMySettlementRequestQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetMySettlementRequestQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: GetMySettlementRequestDocument, ...options });
}
...
export function useGetMySettlementRequestsQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetMySettlementRequestsQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: GetMySettlementRequestsDocument, ...options });
}
...
export function useUpdateSettlementRequestMutation() {
  ...
  >(UpdateSettlementRequestDocument);
}
