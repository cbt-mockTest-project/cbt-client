...
export type CreateCategoryEvaluationMutation = {
  __typename?: 'Mutation';
...
export type DeleteCategoryEvaluationMutation = {
  __typename?: 'Mutation';
  deleteCategoryEvaluation: {
...
export type UpdateCategoryEvaluationMutation = {
  __typename?: 'Mutation';
...
export type CheckIfCategoryEvaluatedMutation = {
  __typename?: 'Mutation';
...
export function useGetCategoryEvaluationQuery(
  options: Omit<Urql.UseQueryArgs<GetCategoryEvaluationQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetCategoryEvaluationQuery,
    GetCategoryEvaluationQueryVariables
  >({ query: GetCategoryEvaluationDocument, ...options });
}
...
export function useCreateCategoryEvaluationMutation() {
  ...
  >(CreateCategoryEvaluationDocument);
}
...
export function useDeleteCategoryEvaluationMutation() {
  ...
  >(DeleteCategoryEvaluationDocument);
}
...
export function useUpdateCategoryEvaluationMutation() {
  ...
  >(UpdateCategoryEvaluationDocument);
}
...
export function useCheckIfCategoryEvaluatedMutation() {
  ...
  >(CheckIfCategoryEvaluatedDocument);
}
