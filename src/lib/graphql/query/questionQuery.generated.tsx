...
export type ReadBookmarkedQuestionsQuery = {
  __typename?: 'Query';
  readBookmarkedQuestions: {
    ...
    questions: Array<{
      ...
      myQuestionState?: Types.QuestionState | null;
      myObjectiveAnswer?: number | null;
...
export type ReadMockExamQuestionsByMockExamIdQuery = {
  ...
  readMockExamQuestionsByMockExamId: {
    ...
    questions: Array<{
      ...
      mockExam?: { __typename?: 'MockExam'; title: string } | null;
      mockExamQuestionFeedback: Array<{
        __typename?: 'MockExamQuestionFeedback';
        id: number;
        content: string;
        ...
        created_at: any;
        updated_at: any;
        user?: { __typename?: 'User'; nickname: string; id: number } | null;
        recommendationCount: {
          __typename?: 'RecommendationCount';
          good: number;
          bad: number;
      ...
      state: Array<{
        ...
        answer: number;
        exam: { __typename?: 'MockExam'; id: number };
      }>;
      mockExamQuestionBookmark: Array<{
        __typename?: 'MockExamQuestionBookmark';
        user: { __typename?: 'User'; id: number };
      }>;
    }>;
...
export type ReadAllQuestionsQuery = {
  __typename?: 'Query';
  readAllQuestions: {
...
export type ReadMockExamQuestionQuery = {
  ...
  readMockExamQuestion: {
    ...
    mockExamQusetion: {
      ...
      user: { __typename?: 'User'; id: number; role: Types.UserRole };
      question_img?: Array<{
        __typename?: 'MockExamImageType';
        url: string;
        uid: string;
...
export type EditMockExamQuestionMutation = {
  __typename?: 'Mutation';
...
export type DeleteMockExamQuestionMutation = {
  __typename?: 'Mutation';
...
export type ReadAllMockExamQuestionQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadAllMockExamQuestionQuery = {
  __typename?: 'Query';
  readAllMockExamQuestion: {
    __typename?: 'ReadAllMockExamQuestionOutput';
    error?: string | null;
    ok: boolean;
    mockExamQuestions: Array<{
      __typename?: 'MockExamQuestion';
      question?: string | null;
      solution?: string | null;
      id: number;
...
export type CreateMockExamQuestionMutation = {
  __typename?: 'Mutation';
...
export type ReadMockExamQuestionNumbersQuery = {
  ...
  readMockExamQuestionNumbers: {
    ...
    error?: string | null;
    ok: boolean;
    examStatus?: Types.ExamStatus | null;
...
export type SearchQuestionsByKeywordQuery = {
  __typename?: 'Query';
...
export type ReadQuestionsByExamIdsQuery = {
  __typename?: 'Query';
  readQuestionsByExamIds: {
...
export function useReadBookmarkedQuestionsQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadBookmarkedQuestionsQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: ReadBookmarkedQuestionsDocument, ...options });
}
...
export function useReadAllQuestionsQuery(
  options: Omit<Urql.UseQueryArgs<ReadAllQuestionsQueryVariables>, 'query'>
) {
  return Urql.useQuery<ReadAllQuestionsQuery, ReadAllQuestionsQueryVariables>({
    query: ReadAllQuestionsDocument,
    ...options,
  });
}
...
export function useDeleteMockExamQuestionMutation() {
  ...
  >(DeleteMockExamQuestionDocument);
}
...
export function useReadAllMockExamQuestionQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadAllMockExamQuestionQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadAllMockExamQuestionDocument, ...options });
}
...
export function useCreateMockExamQuestionMutation() {
  ...
  >(CreateMockExamQuestionDocument);
}
...
export function useSearchQuestionsByKeywordQuery(
  options: Omit<
    Urql.UseQueryArgs<SearchQuestionsByKeywordQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: SearchQuestionsByKeywordDocument, ...options });
}
...
export function useReadQuestionsByExamIdsQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadQuestionsByExamIdsQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadQuestionsByExamIdsDocument, ...options });
}
