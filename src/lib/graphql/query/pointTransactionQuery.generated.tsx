...
export type GetPointTransactionsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetPointTransactionsQuery = {
  __typename?: 'Query';
...
export type CreatePointTransactionForAdminMutation = {
  __typename?: 'Mutation';
  createPointTransactionForAdmin: {
...
export function useGetPointTransactionsQuery(
  options?: Omit<Urql.UseQueryArgs<GetPointTransactionsQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetPointTransactionsQuery,
    GetPointTransactionsQueryVariables
  >({ query: GetPointTransactionsDocument, ...options });
}
...
export function useGetPointTransactionsForAdminQuery(
  options: Omit<
    Urql.UseQueryArgs<GetPointTransactionsForAdminQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: GetPointTransactionsForAdminDocument, ...options });
}
...
export function useCreatePointTransactionForAdminMutation() {
  return Urql.useMutation<
    CreatePointTransactionForAdminMutation,
    CreatePointTransactionForAdminMutationVariables
  >(CreatePointTransactionForAdminDocument);
}
