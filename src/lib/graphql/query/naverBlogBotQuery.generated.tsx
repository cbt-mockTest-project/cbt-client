...
export type GetKeywordSearchCountQuery = {
  __typename?: 'Query';
...
export type GetBlogCategoryListQuery = {
  __typename?: 'Query';
  getBlogCategoryList: {
...
export type GetSearchAvailabilityQuery = {
  __typename?: 'Query';
...
export type GetSearchRankQuery = {
  __typename?: 'Query';
  getSearchRank: {
    __typename?: 'GetSearchRankOutput';
    naverBlogSearchRank?: number | null;
    ok: boolean;
    error?: string | null;
...
export function useGetKeywordSearchCountQuery(
  options: Omit<Urql.UseQueryArgs<GetKeywordSearchCountQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetKeywordSearchCountQuery,
    GetKeywordSearchCountQueryVariables
  >({ query: GetKeywordSearchCountDocument, ...options });
}
...
export function useGetBlogCategoryListQuery(
  options: Omit<Urql.UseQueryArgs<GetBlogCategoryListQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetBlogCategoryListQuery,
    GetBlogCategoryListQueryVariables
  >({ query: GetBlogCategoryListDocument, ...options });
}
...
export function useGetSearchAvailabilityQuery(
  options: Omit<Urql.UseQueryArgs<GetSearchAvailabilityQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetSearchAvailabilityQuery,
    GetSearchAvailabilityQueryVariables
  >({ query: GetSearchAvailabilityDocument, ...options });
}
...
export function useGetSearchRankQuery(
  options: Omit<Urql.UseQueryArgs<GetSearchRankQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetSearchRankQuery, GetSearchRankQueryVariables>({
    query: GetSearchRankDocument,
    ...options,
  });
}
...
export function useGetBlogInfoQuery(
  options: Omit<Urql.UseQueryArgs<GetBlogInfoQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetBlogInfoQuery, GetBlogInfoQueryVariables>({
    query: GetBlogInfoDocument,
    ...options,
  });
}
