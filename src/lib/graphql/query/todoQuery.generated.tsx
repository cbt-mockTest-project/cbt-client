...
export type CreateOrUpdateTodoMutation = {
  __typename?: 'Mutation';
  createOrUpdateTodo: {
...
export function useGetTodoQuery(
  options: Omit<Urql.UseQueryArgs<GetTodoQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetTodoQuery, GetTodoQueryVariables>({
