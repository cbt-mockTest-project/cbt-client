...
export type CreateMockExamQuestionFeedbackMutation = {
  __typename?: 'Mutation';
...
export type UpdateMockExamQuestionFeedbackRecommendationMutationVariables =
  Types.Exact<{
...
export type GetFeedbacksByRecommendationCountQuery = {
  __typename?: 'Query';
  getFeedbacksByRecommendationCount: {
...
export type EditMockExamQuestionFeedbackMutation = {
  __typename?: 'Mutation';
  editMockExamQuestionFeedback: {
...
export function useCreateMockExamQuestionFeedbackMutation() {
  ...
  >(CreateMockExamQuestionFeedbackDocument);
}
...
export function useUpdateMockExamQuestionFeedbackRecommendationMutation() {
  ...
  >(UpdateMockExamQuestionFeedbackRecommendationDocument);
}
...
export function useGetFeedbacksByRecommendationCountQuery(
  options: Omit<
    Urql.UseQueryArgs<GetFeedbacksByRecommendationCountQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: GetFeedbacksByRecommendationCountDocument, ...options });
}
...
export function useEditMockExamQuestionFeedbackMutation() {
  ...
  >(EditMockExamQuestionFeedbackDocument);
}
