...
export type EditQuizCommentMutation = { __typename?: 'Mutation', editQuizComment: { __typename?: 'EditQuizCommentOutput', error?: string | null, ok: boolean } };
...
export type DeleteQuizCommentMutation = { __typename?: 'Mutation', deleteQuizComment: { __typename?: 'DeleteQuizCommentOutput', error?: string | null, ok: boolean } };
...
export function useGetQuizsQuery(options: Omit<Urql.UseQueryArgs<GetQuizsQueryVariables>, 'query'>) {
  return Urql.useQuery<GetQuizsQuery, GetQuizsQueryVariables>({ query: GetQuizsDocument, ...options });
};
...
export function useEditQuizCommentMutation() {
  return Urql.useMutation<EditQuizCommentMutation, EditQuizCommentMutationVariables>(EditQuizCommentDocument);
};
...
export function useCreateQuizCommentMutation() {
  return Urql.useMutation<CreateQuizCommentMutation, CreateQuizCommentMutationVariables>(CreateQuizCommentDocument);
};
...
export function useDeleteQuizCommentMutation() {
  return Urql.useMutation<DeleteQuizCommentMutation, DeleteQuizCommentMutationVariables>(DeleteQuizCommentDocument);
};