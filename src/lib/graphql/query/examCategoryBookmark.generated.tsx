...
export type ToggleExamCategorieBookmarkMutation = {
  __typename?: 'Mutation';
...
export type GetExamCategorySubscribersQuery = {
  __typename?: 'Query';
...
export type DeleteExamCategoryBookmarkMutation = {
  __typename?: 'Mutation';
...
export type CheckIsAccessibleCategoryMutation = {
  __typename?: 'Mutation';
  checkIsAccessibleCategory: {
...
export type CheckHasCategoryAccessMutation = {
  __typename?: 'Mutation';
  checkHasCategoryAccess: {
...
export function useToggleExamCategorieBookmarkMutation() {
  ...
  >(ToggleExamCategorieBookmarkDocument);
}
...
export function useGetExamCategorySubscribersQuery(
  options: Omit<
    Urql.UseQueryArgs<GetExamCategorySubscribersQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: GetExamCategorySubscribersDocument, ...options });
}
...
export function useDeleteExamCategoryBookmarkMutation() {
  ...
  >(DeleteExamCategoryBookmarkDocument);
}
...
export function useCheckIsAccessibleCategoryMutation() {
  ...
  >(CheckIsAccessibleCategoryDocument);
}
...
export function useCheckHasCategoryAccessMutation() {
  ...
  >(CheckHasCategoryAccessDocument);
}
