...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'MeOutput', ok: boolean, error?: string | null, user?: { __typename?: 'User', hasBookmarkedBefore?: boolean | null, randomExamLimit?: number | null, hasSolvedBefore?: boolean | null, solveLimit?: number | null, profileImg: string, usedFreeTrial: boolean, nickname: string, id: number, role: Types.UserRole, email: string, recentlyStudiedCategory: string, userRoles: Array<{ __typename?: 'UserAndRole', created_at: any, role: { __typename?: 'Role', name: string, id: number } }> } | null, notices?: Array<{ __typename?: 'Notice', content: string, id: number, created_at: any, confirm: boolean, link?: string | null }> | null } };
...
export type SearchUserQuery = { __typename?: 'Query', searchUser: { __typename?: 'SearchUserOutput', error?: string | null, ok: boolean, users?: Array<{ __typename?: 'User', id: number, email: string, nickname: string, userRoles: Array<{ __typename?: 'UserAndRole', role: { __typename?: 'Role', id: number, name: string } }> }> | null } };
...
export type CreateFreeTrialRoleMutationVariables = Types.Exact<{ [key: string]: never; }>;
