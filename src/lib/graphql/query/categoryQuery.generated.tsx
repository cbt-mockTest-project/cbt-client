...
export type SearchMockExamCategoriesQuery = {
  __typename?: 'Query';
  searchMockExamCategories: {
    ...
    categories?: Array<{
      ...
      user: { __typename?: 'User'; nickname: string; profileImg: string };
    }> | null;
  };
};
...
export function useSearchMockExamCategoriesQuery(
  options: Omit<
    Urql.UseQueryArgs<SearchMockExamCategoriesQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: SearchMockExamCategoriesDocument, ...options });
}
