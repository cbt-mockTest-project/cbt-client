...
export type ReadQuestionBookmarkFoldersQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadQuestionBookmarkFoldersQuery = {
  __typename?: 'Query';
...
export type CreateQuestionBookmarkFolderMutation = {
  __typename?: 'Mutation';
...
export type DeleteQuestionBookmarkFolderMutation = {
  __typename?: 'Mutation';
...
export type UpdateQuestionBookmarkFolderMutation = {
  __typename?: 'Mutation';
...
export function useReadQuestionBookmarkFoldersQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadQuestionBookmarkFoldersQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: ReadQuestionBookmarkFoldersDocument, ...options });
}
...
export function useCreateQuestionBookmarkFolderMutation() {
  ...
  >(CreateQuestionBookmarkFolderDocument);
}
...
export function useDeleteQuestionBookmarkFolderMutation() {
  ...
  >(DeleteQuestionBookmarkFolderDocument);
}
...
export function useUpdateQuestionBookmarkFolderMutation() {
  ...
  >(UpdateQuestionBookmarkFolderDocument);
}
