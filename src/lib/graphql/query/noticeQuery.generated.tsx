...
export type EditNoticeMutation = { __typename?: 'Mutation', editNotice: { __typename?: 'EditNoticeOutput', error?: string | null, ok: boolean } };
...
export type DeleteNoticeMutation = { __typename?: 'Mutation', deleteNotice: { __typename?: 'DeleteNoticeOutput', error?: string | null, ok: boolean } };

export type DeleteAllNoticesOfMeMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type DeleteAllNoticesOfMeMutation = { __typename?: 'Mutation', deleteAllNoticesOfMe: { __typename?: 'CoreOutput', error?: string | null, ok: boolean } };
...
export function useDeleteAllNoticesOfMeMutation() {
  return Urql.useMutation<DeleteAllNoticesOfMeMutation, DeleteAllNoticesOfMeMutationVariables>(DeleteAllNoticesOfMeDocument);
};