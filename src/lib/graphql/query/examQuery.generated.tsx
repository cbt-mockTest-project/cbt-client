...
export type GetCategoryNamesAndSlugsQueryVariables = Types.Exact<{
  input: Types.GetCategoryNamesAndSlugsInput;
}>;


export type GetCategoryNamesAndSlugsQuery = { __typename?: 'Query', getCategoryNamesAndSlugs: { __typename?: 'GetCategoryNamesAndSlugsOutput', urlSlugs?: Array<string> | null, ok: boolean, names?: Array<string> | null, error?: string | null } };
...
export type ReadMockExamCategoryByCategoryIdQuery = { __typename?: 'Query', readMockExamCategoryByCategoryId: { __typename?: 'ReadMockExamCategoryByCategoryIdOutput', error?: string | null, ok: boolean, category?: { __typename?: 'MockExamCategory', examType: Types.ExamType, hasAccess?: boolean | null, isBookmarked?: boolean | null, id: number, source: Types.ExamSource, name: string, description: string, isPublic: boolean, urlSlug: string, revenueRequestForm?: { __typename?: 'RevenueRequestForm', status: Types.RevenueRequestFormStatus, reason?: string | null } | null, mockExam: Array<{ __typename?: 'MockExam', examType: Types.ExamType, slug?: string | null, title: string, id: number, accesibleRoleIds: Array<number>, isBookmarked?: boolean | null, mockExamQuestion: Array<{ __typename?: 'MockExamQuestion', id: number }>, user: { __typename?: 'User', profileImg: string, id: number, nickname: string } }>, user: { __typename?: 'User', profileImg: string, id: number, nickname: string } } | null } };
...
export type ReadMockExamQuery = { __typename?: 'Query', readMockExam: { __typename?: 'ReadMockExamOutput', error?: string | null, ok: boolean, mockExam: { __typename?: 'MockExam', id: number, title: string, uuid: string, approved: boolean, mockExamQuestion: Array<{ __typename?: 'MockExamQuestion', id: number, orderId: string, linkedQuestionIds?: Array<number> | null, question?: string | null, solution?: string | null, question_img?: Array<{ __typename?: 'MockExamImageType', url: string, name: string, uid: string }> | null, solution_img?: Array<{ __typename?: 'MockExamImageType', url: string, uid: string, name: string }> | null, objectiveData?: { __typename?: 'ObjectiveData', answer: number, content: Array<{ __typename?: 'ObjectiveContent', content: string, url: string }> } | null }> } } };
...
export const GetCategoryNamesAndSlugsDocument = gql`
...
export function useGetCategoryNamesAndSlugsQuery(options: Omit<Urql.UseQueryArgs<GetCategoryNamesAndSlugsQueryVariables>, 'query'>) {
  return Urql.useQuery<GetCategoryNamesAndSlugsQuery, GetCategoryNamesAndSlugsQueryVariables>({ query: GetCategoryNamesAndSlugsDocument, ...options });
};
