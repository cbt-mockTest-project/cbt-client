...
export type ReadAllMockExamCategoriesQuery = {
  ...
  readAllMockExamCategories: {
    ...
    categories: Array<{
      ...
      name: string;
      id: number;
      user: { __typename?: 'User'; nickname: string; role: Types.UserRole };
      partner?: { __typename?: 'Partner'; id: number } | null;
    }>;
  };
};
...
export type EditMockExamCategoryMutation = {
  __typename?: 'Mutation';
...
export type ReadMyMockExamCategoriesQuery = {
  __typename?: 'Query';
...
export type EditMockExamMutation = {
  __typename?: 'Mutation';
  editMockExam: {
...
export type DeleteMockExamMutation = {
  __typename?: 'Mutation';
  deleteMockExam: {
...
export type DeleteMockExamCategoryMutation = {
  __typename?: 'Mutation';
...
export type CreateMockExamMutation = {
  ...
  createMockExam: {
    ...
    error?: string | null;
    ok: boolean;
    mockExam?: { __typename?: 'MockExam'; id: number; title: string } | null;
  };
};
...
export type CreateMockExamCategoryMutation = {
  __typename?: 'Mutation';
...
export type ReadMockExamTitlesByCateoryQuery = {
  __typename?: 'Query';
  readMockExamTitlesByCateory: {
...
export type FindMyExamHistoryQuery = {
  __typename?: 'Query';
  findMyExamHistory: {
...
export type ReadAllMockExamQuery = {
  ...
  readAllMockExam: {
    ...
    error?: string | null;
    ok: boolean;
    mockExams: Array<{ __typename?: 'MockExam'; id: number }>;
  };
};
...
export type UpdateExamOrderMutation = {
  __typename?: 'Mutation';
  updateExamOrder: {
...
export type CreateExamCategoryViewerMutation = {
  __typename?: 'Mutation';
  createExamCategoryViewer: {
...
export type GetExamCategoryViewersQuery = {
  __typename?: 'Query';
  getExamCategoryViewers: {
    ...
    examViewers?: Array<{
      ...
      id: number;
      isApprove: boolean;
      user: { __typename?: 'User'; email: string; nickname: string };
    }> | null;
  };
};
...
export type DeleteExamCategoryViewerMutation = {
  __typename?: 'Mutation';
  deleteExamCategoryViewer: {
...
export type UpdateExamViewerApproveStateMutation = {
  __typename?: 'Mutation';
  updateExamViewerApproveState: {
...
export type GetInvitedExamsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetInvitedExamsQuery = {
  __typename?: 'Query';
  getInvitedExams: {
...
export type ReadMockExamCategoryByExamIdQuery = {
  __typename?: 'Query';
...
export type ReadMockExamCategoriesQuery = {
  __typename?: 'Query';
...
export type ReadMockExamCategoryIdsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadMockExamCategoryIdsQuery = {
  __typename?: 'Query';
...
export type ReadMockExamCategoryNamesQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadMockExamCategoryNamesQuery = {
  __typename?: 'Query';
  readMockExamCategoryNames: {
    __typename?: 'ReadMockExamCategoryNamesOutput';
    urlSlugs?: Array<string> | null;
    error?: string | null;
...
export type ReadMockExamCategoryByCategoryIdQuery = {
  __typename?: 'Query';
  readMockExamCategoryByCategoryId: {
...
export type GetExamCategoriesForAdminQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetExamCategoriesForAdminQuery = {
  __typename?: 'Query';
...
export type GetExamCategoriesV2Query = {
  __typename?: 'Query';
  getExamCategoriesV2: {
    __typename?: 'GetExamCategoriesOutput';
    ok: boolean;
...
export type GetExamCategoriesQuery = {
  __typename?: 'Query';
  getExamCategories: {
    __typename?: 'GetExamCategoriesOutput';
    ok: boolean;
...
export type GetMyExamsQuery = {
  ...
  getMyExams: {
    ...
    exams?: Array<{
      ...
      title: string;
      isBookmarked?: boolean | null;
      mockExamQuestion: Array<{ __typename?: 'MockExamQuestion'; id: number }>;
      user: {
        __typename?: 'User';
        profileImg: string;
        id: number;
...
export type AddExamToCategoryMutation = {
  __typename?: 'Mutation';
  addExamToCategory: {
...
export type RemoveExamFromCategoryMutation = {
  __typename?: 'Mutation';
  removeExamFromCategory: {
...
export type GetMyExamCategoriesQueryVariables = Types.Exact<{
  [key: string]: never;
}>;
  ...
  readMockExam: {
    ...
    mockExam: {
      ...
      mockExamQuestion: Array<{
        ...
        id: number;
        orderId: string;
        linkedQuestionIds?: Array<number> | null;
...
export type GetExamCategoryLearningProgressQuery = {
  __typename?: 'Query';
...
export type GetMyAllExamCategoriesLearningProgressQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetMyAllExamCategoriesLearningProgressQuery = {
  __typename?: 'Query';
...
export type MoveExamOrderMutation = {
  __typename?: 'Mutation';
  moveExamOrder: {
...
export function useReadMyMockExamCategoriesQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadMyMockExamCategoriesQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMyMockExamCategoriesDocument, ...options });
}
...
export function useEditMockExamMutation() {
  return Urql.useMutation<EditMockExamMutation, EditMockExamMutationVariables>(
    EditMockExamDocument
  );
}
...
export function useDeleteMockExamCategoryMutation() {
  ...
  >(DeleteMockExamCategoryDocument);
}
...
export function useCreateMockExamCategoryMutation() {
  ...
  >(CreateMockExamCategoryDocument);
}
...
export function useReadMockExamTitlesByCateoryQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamTitlesByCateoryQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMockExamTitlesByCateoryDocument, ...options });
}
...
export function useFindMyExamHistoryQuery(
  options: Omit<Urql.UseQueryArgs<FindMyExamHistoryQueryVariables>, 'query'>
) {
  return Urql.useQuery<FindMyExamHistoryQuery, FindMyExamHistoryQueryVariables>(
    { query: FindMyExamHistoryDocument, ...options }
  );
}
...
export function useCreateExamCategoryViewerMutation() {
  ...
  >(CreateExamCategoryViewerDocument);
}
...
export function useGetExamCategoryViewersQuery(
  options: Omit<
    Urql.UseQueryArgs<GetExamCategoryViewersQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: GetExamCategoryViewersDocument, ...options });
}
...
export function useDeleteExamCategoryViewerMutation() {
  ...
  >(DeleteExamCategoryViewerDocument);
}
...
export function useUpdateExamViewerApproveStateMutation() {
  ...
  >(UpdateExamViewerApproveStateDocument);
}
...
export function useGetInvitedExamsQuery(
  options?: Omit<Urql.UseQueryArgs<GetInvitedExamsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetInvitedExamsQuery, GetInvitedExamsQueryVariables>({
    query: GetInvitedExamsDocument,
    ...options,
  });
}
...
export function useReadMockExamCategoryByExamIdQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamCategoryByExamIdQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMockExamCategoryByExamIdDocument, ...options });
}
...
export function useReadMockExamCategoriesQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamCategoriesQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMockExamCategoriesDocument, ...options });
}
...
export function useReadMockExamCategoryIdsQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadMockExamCategoryIdsQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
    ReadMockExamCategoryIdsQuery,
    ReadMockExamCategoryIdsQueryVariables
  >({ query: ReadMockExamCategoryIdsDocument, ...options });
}
...
export function useReadMockExamCategoryNamesQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadMockExamCategoryNamesQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
    ReadMockExamCategoryNamesQuery,
    ReadMockExamCategoryNamesQueryVariables
  >({ query: ReadMockExamCategoryNamesDocument, ...options });
}
...
export function useReadMockExamCategoryByCategoryIdQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamCategoryByCategoryIdQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMockExamCategoryByCategoryIdDocument, ...options });
}
...
export function useGetExamCategoriesForAdminQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetExamCategoriesForAdminQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
    GetExamCategoriesForAdminQuery,
    GetExamCategoriesForAdminQueryVariables
  >({ query: GetExamCategoriesForAdminDocument, ...options });
}
...
export function useGetExamCategoriesV2Query(
  options: Omit<Urql.UseQueryArgs<GetExamCategoriesV2QueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetExamCategoriesV2Query,
    GetExamCategoriesV2QueryVariables
  >({ query: GetExamCategoriesV2Document, ...options });
}
...
export function useGetExamCategoriesQuery(
  options: Omit<Urql.UseQueryArgs<GetExamCategoriesQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetExamCategoriesQuery, GetExamCategoriesQueryVariables>(
    { query: GetExamCategoriesDocument, ...options }
  );
}
...
export function useGetMyExamsQuery(
  options: Omit<Urql.UseQueryArgs<GetMyExamsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetMyExamsQuery, GetMyExamsQueryVariables>({
    query: GetMyExamsDocument,
    ...options,
  });
}
...
export function useRemoveExamFromCategoryMutation() {
  ...
  >(RemoveExamFromCategoryDocument);
}
...
export function useGetMyExamCategoriesQuery(
  options?: Omit<Urql.UseQueryArgs<GetMyExamCategoriesQueryVariables>, 'query'>
) {
  return Urql.useQuery<
    GetMyExamCategoriesQuery,
    GetMyExamCategoriesQueryVariables
  >({ query: GetMyExamCategoriesDocument, ...options });
}
...
export function useSaveExamMutation() {
  return Urql.useMutation<SaveExamMutation, SaveExamMutationVariables>(
    SaveExamDocument
  );
}
...
export function useGetExamCategoryLearningProgressQuery(
  options: Omit<
    Urql.UseQueryArgs<GetExamCategoryLearningProgressQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: GetExamCategoryLearningProgressDocument, ...options });
}
...
export function useGetMyAllExamCategoriesLearningProgressQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetMyAllExamCategoriesLearningProgressQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: GetMyAllExamCategoriesLearningProgressDocument, ...options });
}
