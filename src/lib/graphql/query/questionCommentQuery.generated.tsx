...
export type CreateMockExamQuestionCommentMutation = {
  __typename?: 'Mutation';
...
export type DeleteMockExamQuestionCommentMutation = {
  __typename?: 'Mutation';
  deleteMockExamQuestionComment: {
...
export type EditMockExamQuestionCommentMutation = {
  __typename?: 'Mutation';
  editMockExamQuestionComment: {
...
export type ReadMockExamQuestionCommentsByQuestionIdQueryVariables =
  Types.Exact<{
    input: Types.ReadMockExamQuestionCommentsByQuestionIdInput;
  }>;

export type ReadMockExamQuestionCommentsByQuestionIdQuery = {
  __typename?: 'Query';
...
export type ReadExamTitleAndIdByQuestionCommentQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadExamTitleAndIdByQuestionCommentQuery = {
  __typename?: 'Query';
  readExamTitleAndIdByQuestionComment: {
    __typename?: 'ReadExamTitleAndIdByQuestionCommentOutput';
    error?: string | null;
    ok: boolean;
    examTitleAndId?: Array<{
...
export type ReadMyQuestionCommentsQuery = {
  __typename?: 'Query';
  readMyQuestionComments: {
...
export function useCreateMockExamQuestionCommentMutation() {
  ...
  >(CreateMockExamQuestionCommentDocument);
}
...
export function useDeleteMockExamQuestionCommentMutation() {
  ...
  >(DeleteMockExamQuestionCommentDocument);
}
...
export function useEditMockExamQuestionCommentMutation() {
  ...
  >(EditMockExamQuestionCommentDocument);
}
...
export function useReadMockExamQuestionCommentsByQuestionIdQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamQuestionCommentsByQuestionIdQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: ReadMockExamQuestionCommentsByQuestionIdDocument, ...options });
}
...
export function useReadExamTitleAndIdByQuestionCommentQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadExamTitleAndIdByQuestionCommentQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadExamTitleAndIdByQuestionCommentDocument, ...options });
}
...
export function useReadMyQuestionCommentsQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMyQuestionCommentsQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMyQuestionCommentsDocument, ...options });
}
