...
export type ResetQuestionBookmarkMutation = { __typename?: 'Mutation', resetQuestionBookmark: { __typename?: 'ResetQuestionBookmarkOutput', error?: string | null, ok: boolean } };
...
export function useResetQuestionBookmarkMutation() {
  return Urql.useMutation<ResetQuestionBookmarkMutation, ResetQuestionBookmarkMutationVariables>(ResetQuestionBookmarkDocument);
};