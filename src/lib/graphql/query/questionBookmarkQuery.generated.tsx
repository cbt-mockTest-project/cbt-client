...
export type EditMockExamQuestionBookmarkMutation = {
  __typename?: 'Mutation';
  editMockExamQuestionBookmark: {
...
export type ReadMockExamQuestionBookmarkQuery = {
  __typename?: 'Query';
  readMockExamQuestionBookmark: {
...
export type ReadExamTitleAndIdOfBookmarkedQuestionQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ReadExamTitleAndIdOfBookmarkedQuestionQuery = {
  __typename?: 'Query';
...
export type ResetMyQuestionBookmarkMutationVariables = Types.Exact<{
  [key: string]: never;
}>;

export type ResetMyQuestionBookmarkMutation = {
  __typename?: 'Mutation';
...
export function useEditMockExamQuestionBookmarkMutation() {
  ...
  >(EditMockExamQuestionBookmarkDocument);
}
...
export function useReadMockExamQuestionBookmarkQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamQuestionBookmarkQueryVariables>,
    'query'
  >
) {
  ...
  >({ query: ReadMockExamQuestionBookmarkDocument, ...options });
}
...
export function useReadExamTitleAndIdOfBookmarkedQuestionQuery(
  options?: Omit<
    Urql.UseQueryArgs<ReadExamTitleAndIdOfBookmarkedQuestionQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadExamTitleAndIdOfBookmarkedQuestionDocument, ...options });
}
...
export function useResetMyQuestionBookmarkMutation() {
  ...
  >(ResetMyQuestionBookmarkDocument);
}
