...
export function useGetBuyersQuery(options?: Omit<Urql.UseQueryArgs<GetBuyersQueryVariables>, 'query'>) {
  return Urql.useQuery<GetBuyersQuery, GetBuyersQueryVariables>({ query: GetBuyersDocument, ...options });
};