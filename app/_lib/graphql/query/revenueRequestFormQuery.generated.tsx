...
export type GetRevenueRequestFormsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetRevenueRequestFormsQuery = { __typename?: 'Query', getRevenueRequestForms: { __typename?: 'GetRevenueRequestFormsOutput', error?: string | null, ok: boolean, revenueRequestForms?: Array<{ __typename?: 'RevenueRequestForm', created_at: any, id: number, reason?: string | null, status: Types.RevenueRequestFormStatus, category: { __typename?: 'MockExamCategory', id: number, urlSlug: string, user: { __typename?: 'User', email: string, id: number } } }> | null } };
...
export type UpdateRevenueRequestFormMutation = { __typename?: 'Mutation', updateRevenueRequestForm: { __typename?: 'UpdateRevenueRequestFormOutput', error?: string | null, ok: boolean } };
...
export function useGetRevenueRequestFormsQuery(options?: Omit<Urql.UseQueryArgs<GetRevenueRequestFormsQueryVariables>, 'query'>) {
  return Urql.useQuery<GetRevenueRequestFormsQuery, GetRevenueRequestFormsQueryVariables>({ query: GetRevenueRequestFormsDocument, ...options });
};
...
export function useUpdateRevenueRequestFormMutation() {
  return Urql.useMutation<UpdateRevenueRequestFormMutation, UpdateRevenueRequestFormMutationVariables>(UpdateRevenueRequestFormDocument);
};